...
enum opt_code
{
  ...
  OPT_mnew_generic_costs = 1208,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1209,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1210,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1211,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1212,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1213,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1214,                   /* -mrestrict-it */
  OPT_msched_prolog = 1215,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1216,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1217,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1218, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1219,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1220,                         /* -mthumb */
  OPT_mthumb_interwork = 1221,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1222,                  /* -mtls-dialect= */
  OPT_mtp_ = 1223,                           /* -mtp= */
  OPT_mtpcs_frame = 1224,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1225,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1226,                         /* -mtune= */
  OPT_muclibc = 1227,                        /* -muclibc */
  OPT_munaligned_access = 1228,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1229,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1230,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1231,              /* -mword-relocations */
  OPT_n = 1232,                              /* -n */
  OPT_no_canonical_prefixes = 1233,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1234,              /* -no-integrated-cpp */
  OPT_no_pie = 1235,                         /* -no-pie */
